                ...
                .disable())
                    .authorizeHttpRequests(authRequest ->
                        authRequest
                            ...
                            .requestMatchers(new AntPathRequestMatcher("/ebs/personas/signUpCliente")).permitAll()
                            .requestMatchers(new AntPathRequestMatcher("/ebs/articulo")).hasAnyAuthority(Rol.CLIENTE.toString(), Rol.COCINERO.toString())
                            ...
                            .requestMatchers(new AntPathRequestMatcher("/ebs/articulo/{id}")).hasAnyAuthority(Rol.CLIENTE.toString(), Rol.COCINERO.toString())
                            .requestMatchers(new AntPathRequestMatcher("/ebs/articulo/{id}")).hasAnyAuthority(Rol.CLIENTE.toString(), Rol.COCINERO.toString())
                            .requestMatchers(new AntPathRequestMatcher("/ebs/articulo/paged")).hasAnyAuthority(Rol.CLIENTE.toString(), Rol.COCINERO.toString())
                            ...
                            .requestMatchers(new AntPathRequestMatcher("/ebs/insumo")).hasAuthority(Rol.COCINERO.toString())
                            .requestMatchers(new AntPathRequestMatcher("/ebs/insumo/{id}")).hasAuthority(Rol.COCINERO.toString())
                            .requestMatchers(new AntPathRequestMatcher("/ebs/insumo/paged")).hasAuthority(Rol.COCINERO.toString())
                            .requestMatchers(new AntPathRequestMatcher("/ebs/personas/signUpEmpleado")).hasAuthority(Rol.ADMINISTRADOR.toString())
