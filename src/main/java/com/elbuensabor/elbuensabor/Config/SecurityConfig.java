                ...
                .disable())
                    .authorizeHttpRequests(authRequest ->
                        authRequest
                            ...
                            .requestMatchers(new AntPathRequestMatcher("/ebs/articulo")).permitAll()
                            //.requestMatchers(new AntPathRequestMatcher("/ebs/articulo")).hasAnyAuthority(Rol.CLIENTE.toString(), Rol.COCINERO.toString(), Rol.ADMINISTRADOR.toString()) para mostrar en la HomePage, se cambió a permitAll()
